...
internal static class Strings
{
    ...
    public static string ScanTargetsMissingFormat = "{0} hedef bulunamadı (taranmadı): {1}";
    public static string CliErrAllTargetsMissing = "HATA: verilen yolların hiçbiri bulunamadı; hiçbir şey taranmadı.";
    ...
    public static string StatusCheckingSignature = "İmza denetleniyor…";
    public static string StatusWaitingLookupSlot = "VirusTotal bağlantı sırası bekleniyor";
    public static string StatusWaitingSameContent = "Aynı içerikteki dosyanın sonucu bekleniyor";
    public static string StatusNetworkHeldFormat = "VirusTotal cevap vermiyor, {0:HH:mm:ss}'e kadar bekleniyor";
    public static string StatusAskingKeyless = "Anahtarsız tarayıcıyla soruluyor";
    ...
    public static string SortActivity = "Son işlem (canlı)";
    public static string SortAdded = "Eklenme sırası";
    public static string SortExtension = "Uzantı (çalıştırılabilir önce)";
    public static string SortName = "Ad";
    public static string SortSize = "Boyut";
    public static string SortStatus = "Durum (gruplu)";
    public static string DetailInProgressTitle = "İşleniyor";
    public static string DetailNoVerdictTitle = "Sonuç yok";
    public static string DetailLblPath = "Yol: ";
    public static string DetailLblArchive = "Arşiv: ";
    public static string DetailLblMember = "Arşivdeki yolu: ";
    public static string DetailLblExtension = "Uzantı: ";
    public static string DetailLblAdded = "Eklendi: ";
    public static string DetailLastActivityFormat = "Son işlem: {0:HH:mm:ss} ({1} önce)";
    public static string DetailLblSignature = "İmza: ";
    public static string DetailSignatureNotChecked = "henüz denetlenmedi";
    public static string DetailSignatureNone = "geçerli imza yok";
    public static string DetailLblError = "Hata: ";
    ...
    public static string StatusSourceCacheBackup = "Önbellek yedeği";
    ...
    public static string UploadPolicyAlways = "Her dosyayı gönder";
    ...
    public static string CaptchaBtnUseTor = "Tor'a geç (yeni IP)";
    ...
    public static string TorStatusOff = "Tor kapalı — doğrudan bağlantı";
    public static string TorStatusStarting = "Tor başlatılıyor…";
    public static string TorStatusOnNoIp = "Tor açık — çıkış IP'si sorgulanıyor…";
    public static string TorStatusOnFormat = "Tor açık · çıkış {0} · {1}";
    public static string TorErrExeNotFound = "tor.exe bulunamadı. Ayarlar → Tor kartından yolunu elle gösterebilirsin.";
    ...
    public static string TorErrNewnymFormat = "Tor yeni devre isteğini reddetti: {0}";
    public static string TorAutoEnablingStatus = "IP engeli tekrarlandı — Tor otomatik açılıyor…";
    public static string TorAutoEnableFailedFormat = "Tor açılamadı: {0}";
    public static string TorCircuitFailedFormat = "Devre değiştirilemedi: {0}";

    // ---- overview / history tooltips ----
    public static string TtOverviewAttention = "Karar bekleyen bir şey varsa burada çıkar; yoksa bu şerit hiç görünmez.";
    public static string TtOverviewStatus = "En son ve en önemli durum bilgisi. Sağdaki düğme seni ilgili sekmeye götürür.";
    public static string TtOverviewQuota = "Anahtarlarında kalan günlük kotanın özeti.";
    public static string TtOverviewTileThreat = "Geçmişte zararlı çıkan dosya sayısı. Tıklayınca Geçmiş sekmesi bu kategoriye filtrelenir.";
    public static string TtOverviewTileSuspicious = "Geçmişte sınırda/şüpheli çıkan dosya sayısı. Tıklayınca Geçmiş sekmesi bu kategoriye filtrelenir.";
    public static string TtOverviewTileClean = "Geçmişte temiz çıkan dosya sayısı. Tıklayınca Geçmiş sekmesi bu kategoriye filtrelenir.";
    public static string TtOverviewRecent = "Son taramalar. Bir satıra tıklayınca sonucu önbellekten yeniden açar (kota harcamaz).";
    public static string TtOverviewDrop = "Dosya veya klasörü buraya sürükleyip bırak; tarama hemen başlar.";
    public static string TtHistoryThreatsOnly = "Sadece zararlı/şüpheli çıkan kayıtları göster.";
    public static string TtHistoryStarredOnly = "Sadece yıldızladığın kayıtları göster.";
    public static string TtHistoryCount = "Filtreden geçen kayıt sayısı / toplam kayıt sayısı.";
    public static string TtHistoryEscBanner = "Daha önce temiz görünüp sonradan zararlıya dönen kayıtlar var. Tıklayınca listeyi açar.";

    // ---- tabs + status bar tooltips ----
    public static string TtTabOverview = "Genel bakış: kapsam kartları, kurulum adımları ve tek tıkla başlatılan taramalar.";
    public static string TtTabScan = "Tarama: dosya/klasör seç, kuyruğu izle, sonuçlara göre işlem yap.";
    public static string TtTabQuota = "Kotalar: her API anahtarının dakikalık/günlük/aylık kullanımı ve sıfırlanma sayacı.";
    public static string TtTabLogs = "Loglar: programın ne yaptığının ayrıntılı kaydı (günlük kaydı açıkken dolar).";
    public static string TtTabHistory = "Geçmiş: şimdiye kadar taranmış her dosyanın kaydı ve yeniden sorgulama araçları.";
    public static string TtTabSettings = "Ayarlar: anahtarlar, güven kaynakları, tarama davranışı, Tor, önbellek yedeği ve genel tercihler.";
    public static string StatusBarTorOn = "Tor açık";
    public static string TtStatusKeys = "Kullanılabilir / toplam API anahtarı sayısı. Kotası dolan anahtar geçici olarak 'kullanılamaz' sayılır.";
    public static string TtStatusActivity = "Arka planda olan son iş. Tıklayınca son olayların listesi açılır.";

    // ---- settings: Tor card ----
    public static string CardTor = "Tor (kaynak IP değiştirme)";
    public static string TorCardHint = "VirusTotal'in anahtarsız (API'siz) arayüzü GÜNLÜK olarak IP başına sınırlıdır. Kotan bitmemiş olsa bile aynı IP'den çok istek gidince her sorgu 429/reCAPTCHA döner ve tarama ilerlemez. Tor açıkken hem API hem de anahtarsız tarayıcı Tor'un çıkış düğümü üzerinden gider; devre değiştirince IP de değişir ve sınır sıfırlanır.";
    public static string TorAutoEnableLabel = "IP engeli tekrarlarsa Tor'u kendiliğinden aç";
    ...
    public static string TorTestOkFormat = "Tor çalışıyor.\n\nÇıkış IP: {0}\nÜlke: {1}";
    public static string TorFoundAtFormat = "Bulundu: {0}";
    public static string TorNotFoundHint = "tor.exe bulunamadı. Kurmak için: scoop install tor  — ya da Tor Browser kurup yolunu buradan göster.";

    // ---- settings: cache backup card ----
    public static string CardCacheBackup = "Önbellek yedeği";
    public static string CacheBackupHint = "cache.json içindeki her kayıt bir kez harcanmış VirusTotal kotasıdır; bu yüzden programda önbelleği silen bir düğme yoktur. Buradan periyodik, tarih damgalı kopyalar alabilirsin. Yedekler birbirinin üstüne yazmaz.";
    public static string CacheBackupFolderLabel = "Yedek klasörü:";
    public static string CacheBackupHoursLabel = "Kaç saatte bir (0 = sadece elle):";
    public static string CacheBackupKeepLabel = "Kaç yedek saklansın (0 = hepsi):";
    public static string BtnBackupNow = "Şimdi yedekle";
    public static string BtnRestoreBackup = "Seçili yedeği geri yükle";
    public static string BtnOpenBackupFolder = "Klasörü aç";
    public static string CacheBackupCountFormat = "{0} yedek · en yenisi: {1}";
    public static string CacheBackupNoneYet = "Henüz yedek yok.";
    public static string CacheRestoreConfirmFormat = "'{0}' yedeği yüklensin mi?\n\nYedekteki kayıtlar mevcut önbelleğin üzerine eklenir; mevcut kayıtlar silinmez. Yükleme öncesi mevcut cache.json ayrıca bir kopya olarak saklanır.";
    public static string CacheRestoredFormat = "Yedek yüklendi. Önbellekte şu an {0} kayıt var.";
    public static string CacheRestoreFailedPrefix = "Yedek yüklenemedi: ";
    public static string BtnPickKeyBackupFile = "Dosya seç…";
    public static string BtnWriteKeyBackupNow = "Anahtarları şimdi yaz";
    public static string KeyBackupPathLabel = "Anahtarların düz metin yedeği:";
    public static string KeyBackupWrittenFormat = "Anahtarlar yazıldı: {0}";
    public static string KeyBackupFailedPrefix = "Anahtar yedeği yazılamadı: ";

    // ---- tooltips: her arayüz elemanı için açıklama ----
    public static string TtScanDownloads = "İndirilenler klasörünü (ve izlemeye aldığın diğer klasörleri) baştan tarar. En son inen dosyalara hızlı bakış için.";
    public static string TtHide = "Bu kartı gizler. Ayarlardan ya da yeniden başlatınca geri gelir.";
    public static string TtCtxInstall = "Windows Gezgin'de dosya/klasör sağ tık menüsüne 'VirusTotal ile tara' komutunu ekler. Yönetici yetkisi ister; kayıt defterine yazar.";
    public static string TtCtxRepair = "Program başka bir klasöre taşındıysa sağ tık menüsündeki eski yolu günceller.";
    public static string TtRemoveGeneric = "Bu kaydı/kurulumu kaldırır.";
    ...
    public static string TtKeyBackupPath = "API anahtarlarının düz metin olarak yazılacağı dosya. Anahtar kasası Windows hesabına bağlı şifrelenir; format atma/yeniden kurulum sonrası okunamaz hale gelir. Bu dosya güvenlik ağıdır: aynı anahtar iki kez yazılmaz, kasadan silinen anahtar dosyada kalır.";
    public static string TtPickKeyBackupFile = "Düz metin anahtar yedeğinin yazılacağı dosyayı seç.";
    public static string TtWriteKeyBackupNow = "Kasadaki anahtarları hemen düz metin dosyasına yazar (yenileri ekler, var olanlara dokunmaz).";
    public static string TtTrustSkipSigned = "Geçerli ve güvenilen bir kod imzası olan dosyalar VirusTotal'e hiç sorulmaz. Kotayı en çok koruyan ayar budur; imzalı dosya 'temiz' demek değil, 'kaynağı belli' demektir.";
    public static string TtTrustMsOnly = "Sadece Microsoft imzalı dosyalar atlanır. Kapatırsan geçerli imzası olan HER yayıncı atlanır — çok daha hızlı, ama imzalı zararlıları da atlar.";
    public static string TtTrustKeyless = "Sorguları önce anahtarsız yoldan (gizli WebView2 tarayıcı, VirusTotal'in kendi arayüzü) yapar: kota harcamaz. Tarayıcı aynı anda tek sorgu yapabildiği için, boş API anahtarı varken sıraya girmez, doğrudan API kullanılır.";
    public static string TtTrustAllow = "Noktalı virgülle ayrılmış yayıncı adı parçaları. Buradaki bir ad imzada geçiyorsa dosya, 'sadece Microsoft' ayarı açık olsa bile atlanır.";
    public static string TtKnownGood = "Satır başına bir MD5/SHA256 içeren kendi 'bilinen temiz' listen. Buradaki hash'ler VirusTotal'e hiç sorulmaz.";
    public static string TtAllowGrid = "'Bunu temiz olarak işaretle' dediğin dosyalar. Bir daha tehdit olarak gösterilmezler. 'Sağlık denetimi' ile bu dosyaların hâlâ temiz sayılıp sayılmadığı yeniden sorulur.";
    public static string TtRemoveFromList = "Seçili kaydı listeden çıkarır.";
    public static string TtReviewMarkClean = "Seçili kaydı 'yeniden gözden geçirildi' olarak damgalar; bayatlamış uyarısı kalkar.";
    public static string TtHealthCheck = "Temiz işaretlediğin dosyaları VirusTotal'de yeniden sorgular; artık zararlı sayılan varsa kırmızı gösterir.";
    public static string TtImportFromHistory = "Geçmişte temiz çıkmış dosyaları toplu olarak temiz listesine ekler.";
    public static string TtFolderGrid = "Bu klasörlerin altındaki dosyalar taranmaz. Hash'i sürekli değişen derleme/çıktı klasörleri için (bin, obj, node_modules gibi).";
    public static string TtWatchGrid = "İndirilenler izleyicisinin baktığı klasörler. Boşsa varsayılan olarak İndirilenler + Masaüstü izlenir.";
    public static string TtAddFolder = "Listeye klasör ekler.";
    public static string TtCatGrid = "Kaç motor işaretlerse hangi etiketin/rengin kullanılacağını sen belirlersin. 'En az tespit' değeri o bandın alt sınırıdır.";
    public static string TtAddRow = "Listeye yeni satır ekler.";
    public static string TtPickColor = "Seçili bandın rengini değiştirir.";
    public static string TtSaveRows = "Bu tablodaki değişiklikleri kaydeder.";
    public static string TtDefaults = "Fabrika ayarlarına döndürür.";
    public static string TtMajorEngines = "'Büyük' sayılan motorların listesi (noktalı virgülle). Sadece küçük/bilinmeyen motorların işaretlediği bir dosya, büyük motorların hiçbiri işaretlemediyse yanlış pozitif olma ihtimali yüksektir; program bu ayrımı bu listeye göre yapar.";
    public static string TtAutoActionGrid = "Tarama sonrası otomatik kurallar; ilk uyan kural uygulanır. 'Arka plan' sütunu işaretliyse kural sadece izleyici/USB gibi sen başlatmadan çalışan taramalarda geçerlidir.";
    public static string TtConcurrency = "EŞZAMANLI TARAMA: aynı anda kaç dosyanın VirusTotal ağ aşamasında (sorgu + yükleme) olabileceği. Yerel işler (hash, imza, önbellek) bundan bağımsız, çekirdek sayısı kadar paralel çalışır. Yüklemeden sonraki analiz bekleme süresi bu sayıyı MEŞGUL ETMEZ; beklerken slot serbest bırakılır, sıradaki dosya hemen başlar. Üst sınır yok — anahtar sayına göre yükseltebilirsin.";
    public static string TtUploads = "PARALEL YÜKLEME: yukarıdaki eşzamanlı taramaların kaç tanesi AYNI ANDA dosya baytı gönderebilir. Ayrı bir sayı olmasının sebebi yüklemenin bant genişliği yemesi: 16 dosyayı aynı anda sorgulamak ucuz, 16 dosyayı aynı anda yüklemek hattı doldurur. Sadece gönderim süresini kapsar; analiz beklemesini değil.";
    public static string TtMaxSize = "Bu boyuttan büyük dosyalar hiç hash'lenmeden atlanır (0 = sınır yok). VirusTotal'in kendi yükleme tavanı ~650 MB'dir.";
    public static string TtRecheckDays = "'Verdikt yeniden denetle' taraması, önbellekte bu günden daha eski olan kayıtları anahtarsız yoldan yeniden sorgular. Kota harcamaz.";
    public static string TtUseCache = "Daha önce sorulmuş dosyalar için VirusTotal'e tekrar gitmez, yerel önbellekten cevaplar. Kapatırsan her tarama baştan kota harcar.";
    ...
    public static string TtPickFolder = "Klasör seç.";
    public static string TtCacheBackupHours = "Kaç saatte bir otomatik yedek alınacağı. 0 = sadece elle yedekle.";
    public static string TtCacheBackupKeep = "Klasörde en fazla kaç yedek tutulacağı; fazlası en eskiden başlayarak silinir. 0 = hiçbiri silinmez.";
    public static string TtBackupNow = "Hemen tarih damgalı bir kopya alır.";
    public static string TtRestoreBackup = "Seçili yedeği yükler. Yedekteki kayıtlar mevcut önbelleğin üzerine EKLENİR (mevcut kayıtlar silinmez), ve yüklemeden önce şu anki cache.json ayrıca kopyalanır.";
    public static string TtOpenBackupFolder = "Yedek klasörünü Gezgin'de açar.";
    public static string TtCacheBackupList = "Klasördeki yedekler, en yenisi üstte. Geri yüklemek istediğini seç.";
    public static string TtSweepFolder = "Windows Görev Zamanlayıcı'nın periyodik olarak tarayacağı klasör.";
    public static string TtSweepInterval = "Zamanlanmış taramanın sıklığı.";
    public static string TtSweepInstall = "Zamanlanmış görevi kurar veya günceller (yönetici yetkisi ister).";
    public static string TtSweepRunNow = "Zamanlanmış taramayı beklemeden bir kez çalıştırır.";
    public static string TtSweepStatus = "Zamanlanmış görevin kurulu olup olmadığı ve hangi klasörü taradığı.";
    public static string TtLanguage = "Arayüz dili. Tam olarak uygulanması için program yeniden başlatılmalı.";
    public static string TtTheme = "Koyu/açık tema, ya da Windows'un temasını takip et.";
    public static string TtStartup = "Windows açılışında programı tepside (gizli) başlatır.";
    public static string TtResumeAsk = "Tarama yarıda kesilirse, sonraki açılışta kaldığı yerden devam etmeyi sorar.";
    public static string TtAutoResume = "Yarım kalan taramayı sormadan devam ettirir.";
    public static string TtTrayMinimize = "Pencereyi kapatmak programı kapatmaz, tepsiye indirir. İzleyiciler çalışmaya devam eder.";
    public static string TtNotifyThreat = "Tehdit bulununca Windows bildirimi gösterir.";
    public static string TtNotifyThreshold = "Bildirim için gereken en az motor sayısı. 1 = her tehditte bildir.";
    public static string TtNotifySummary = "Tarama bitince temiz/şüpheli/tehdit sayılarını tek bildirimde özetler.";
    public static string TtShowVotes = "Detay panelinde VirusTotal topluluk oylarını gösterir.";
    public static string TtWatchDownloads = "İzlenen klasörlere yeni inen çalıştırılabilir dosyaları anında tarar.";
    public static string TtWatchUsb = "USB bellek/harici disk takılınca taramayı teklif eder.";
    public static string TtAutoScanUsb = "Takılan sürücüyü sormadan, arka planda tarar. Yüksek tespitli bulgular otomatik karantina kuralına girer.";
    public static string TtProcGuard = "Yeni başlatılan her çalıştırılabilir dosyayı anında denetler (WMI kullanır, yönetici yetkisi ister). Sohbetten/e-postadan gelip çift tıklanan bilinmeyen exe'yi yakalar.";
    public static string TtSignatureSoften = "Tam geçerli imzası olan ve sadece 1-2 sezgisel tespit alan dosyaları 'muhtemel yanlış pozitif' diye işaretler. Sadece ipucudur; verdikt bandını değiştirmez, tehdidi gizlemez.";
    public static string TtAutoQuarantine = "Arka plandaki (izleyici/USB) taramalarda açıkça zararlı olanları sen tıklamadan karantinaya alır. Geri alma bildirimi çıkar.";
    public static string TtAutoQuarantineThreshold = "Otomatik karantina için gereken en az motor sayısı. Yüksek tut (ör. 10) ki sadece bariz zararlılar taşınsın. 0 = otomatik karantina kapalı.";
    public static string TtMuteFullscreen = "Tam ekran bir uygulama (oyun/sunum) öndeyken acil olmayan bildirimleri bekletir, sonra topluca gösterir.";
    public static string TtQuietHours = "Bu saat aralığında acil olmayan bildirimler bekletilir. Başlangıç ile bitiş aynıysa sessiz saat yoktur.";
    public static string TtRetention = "Karantinadaki dosyalar bu günden eskiyse açılışta kalıcı silinir. 0 = hiç silme.";
    public static string TtPeriodic = "Program tepside beklerken kaç saatte bir izleme listesi / eskiyen önbellek / bütünlük denetimi yapılacağı. Kotasız çalışır. 0 = sadece açılışta.";
    public static string TtLedgerExport = "Önbellekteki verdiktleri paylaşılabilir bir JSON dosyasına yazar (ekip içinde kota paylaşmak için).";
    public static string TtLedgerImport = "Başka bir makineden gelen verdikt dosyasını önbelleğe katar.";
    public static string TtLogging = "Ayrıntılı günlük kaydını açar/kapatır. Bir sorunu incelerken aç; sürekli açık kalırsa disk yazar.";
    public static string TtSettingsSearch = "Ayar adı veya etiketi yaz; eşleşmeyen kartlar gizlenir. Esc temizler.";
    public static string TtAskAgain = "Bu işlem için 'bir daha sorma' dediğin onayı geri açar.";
    public static string TtGetKeyLink = "VirusTotal'in API anahtarı sayfasını tarayıcıda açar.";
    public static string TtResetAll = "Bütün ayarları fabrika değerlerine döndürür. API anahtarları ve önbellek silinmez.";
    public static string TtExportSettings = "Ayarları bir metin dosyasına yazar.";
    public static string TtImportSettings = "Daha önce dışa aktarılmış ayarları geri yükler.";
    public static string TtQuotaRefresh = "Her anahtar için gerçek kullanım değerlerini VirusTotal'den çeker ve yerel sayaçları buna göre düzeltir. Her anahtar için 1 istek harcar.";
    public static string TtQuotaCards = "Anahtar başına dakikalık / günlük / aylık kullanım. Çubuk dolduğunda o anahtar sıfırlanana kadar atlanır. Günlük kota UTC gece yarısında sıfırlanır.";
    public static string TtQuotaBanner = "Bütün anahtarlar dolduğunda, en yakın sıfırlanmaya kalan süre.";
    public static string TtHistoryGrid = "Şimdiye kadar taranmış her dosyanın kaydı: ne zaman, hangi verdikt, hangi hash. Satıra sağ tıklayarak yeniden tarayabilirsin.";
    public static string TtHistorySearch = "Geçmişte dosya adı / yol / hash araması.";
    public static string TtHistoryClear = "Tarama geçmişi kayıtlarını siler. Hash önbelleği bundan etkilenmez, silinmez.";
    public static string TtHistoryReverdict = "Geçmişteki dosyaları anahtarsız yoldan yeniden sorgular; verdikti değişenleri listeler.";
    public static string TtHistoryExport = "Geçmişi rapor dosyasına aktarır.";
    public static string TtHistoryRecurring = "Aynı dosyanın tekrar tekrar karşına çıktığı yerleri gösterir.";
    public static string TtHistoryHotspots = "En çok tehdit çıkan klasörleri sıralar.";
    public static string TtLogBox = "Program günlüğünün canlı akışı. Günlük kaydı kapalıysa burası boş kalır.";
    public static string TtLogClear = "Ekrandaki günlük tamponunu temizler (disktekilere dokunmaz).";
    public static string TtLogCopyAll = "Tüm günlüğü panoya kopyalar.";
    public static string TtLogOpenFolder = "Günlük dosyalarının bulunduğu klasörü açar.";
    public static string TtDetailQuarantine = "Dosyayı çalıştırılamaz hale getirip karantina kasasına taşır. Geri alınabilir.";
    public static string TtDetailRescan = "Bu dosyayı yeniden tarar.";
    public static string TtDetailVtReport = "Dosyanın VirusTotal sayfasını tarayıcıda açar.";
    public static string TtDetailMarkClean = "Bu dosyayı temiz olarak işaretler; bir daha tehdit olarak gösterilmez.";
    public static string TtTorAutoEnable = "Aynı gün içinde IP engeli belirli sayıda tekrarlarsa Tor kendiliğinden açılır ve tarama kesilmeden devam eder.";
    ...
    public static string CacheBackupNoSourceFormat = "Kaynak dosya yok: {0}";
    public static string CacheBackupDoneFormat = "Önbellek yedeklendi: {0}";
    public static string CacheBackupFailedFormat = "Önbellek yedeklenemedi: {0}";
    public static string CacheBackupFellBackFormat = "Seçilen klasöre yazılamadı ({0}). Yedek şuraya alındı: {1}";
    public static string KeyBackupNoPath = "Anahtar yedek dosyası yolu boş.";
    public static string KeyBackupFellBackFormat = "Seçilen dosyaya yazılamadı ({0}). Yedek şuraya alındı: {1}";
